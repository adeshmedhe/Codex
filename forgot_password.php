...
<form class="form-horizontal" role="form" action="enter_otp.php" method="POST" id="form1" >
    <h3 class="text text-center "><b>Enter email</b></h3>
    <div class="form-group">
        <label for="email" class="col-sm-3 control-label">Enter Email</label>
        <div class="col-sm-9">
            <input type="email" id="email" name="email" placeholder="Enter registered email" class="form-control" autofocus required>
        </div>
    ...
    <div class="form-group">
        <div class="mx-4 text-center">
            <button type="submit" class="btn btn-primary" name="email_entered" id="email_entered" >Send OTP</button>
        </div>
    </div>
</form>
